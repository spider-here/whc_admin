...
import 'package:whc_admin/controllers/order_details_controller.dart';
                ...
                title: Row(
                  ...
                  children: [
                    ...
                    SelectableText(
                      ...
                      style: const TextStyle(fontSize: 24.0, color: kBlack),
                    ),
                  ],
                ),
              ),
                                  ...
                                  Table(
                                    ...
                                    children: [
                                      ...
                                      TableRow(children: [
                                        ...
                                        _widgets.orderDetailCell(
                                            info: "Time Stamp",
                                            value: _getC.getDateTime(snapshot
                                                .data!
                                                .get('timestamp'))),
                                      ]),
                                    ],
                                      ...
                                      contentsBuilder: (context, index) {
                                        return Padding(
                                          ...
                                          child: Text(
                                            ...
                                            style: TextStyle(
                                              fontSize: 11,
                                              color: (_getC.getOrderStatusIndex(
                                                          snapshot.data!
                                                              .get('status')) ==
                                                      index)
                                                  ? kPrimaryColor
                                        ...
                                        child: DropdownButton(
                                            ...
                                            items: [
                                              DropdownMenuItem(
                                                value: 0,
                                                child:
                                                    Text(_getC.statusText[0]),
                                              ),
                                              DropdownMenuItem(
                                                value: 1,
                                                child:
                                                    Text(_getC.statusText[1]),
                                              ),
                                              DropdownMenuItem(
                                                value: 2,
                                                child:
                                                    Text(_getC.statusText[2]),
                                              ),
                                              DropdownMenuItem(
                                                value: 3,
                                                child:
                                                    Text(_getC.statusText[3]),
                                              ),
                                            ],
                                            onChanged: (value) {
                                              _getC.dropDownMenuValue.value =
                                                  value!;
                                              _getC.updateButtonVisibility
                                                  .value = true;
                                            }),
                                      ),
                                      const Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                _getC.updateOrderStatus(
                                                    orderID: orderID,
                                                    status: _getC.statusText[
                                                        _getC.dropDownMenuValue
                                                            .value]);
                                              },
