...
import '../../../controllers/addLabController.dart';
import '../../../database/database.dart';
import '../../../utils/constants.dart';
import '../../../utils/customWidgets.dart';

class dAddLabScreen extends StatelessWidget {
  ...
  dAddLabScreen({super.key});
  dAddLabScreen.edit({super.key, required this.edit, required this.id,  required this.labName,
