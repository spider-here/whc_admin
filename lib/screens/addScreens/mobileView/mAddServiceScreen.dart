...
class mAddServiceScreen extends StatelessWidget {
                            ...
                            if (_titleC.text.length != 0 &&
                              ...
                              if (extension == 'jpe' ||
                                ...
                                await _db
                                  ...
                                  _getC.progressVisibility = false;
                                  controller.update();
                                  Get.snackbar("Error", "Problem adding image.",
                                      backgroundColor: kWhite);
                                });
                              } else {
                                Get.snackbar("Error",
                                    "Only images with \".jpeg\" and \".png\" formats can be added.",
                                    backgroundColor: kWhite);
                              }
